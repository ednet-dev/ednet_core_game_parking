...
abstract class BrandGen extends Entity<Brand> {
  BrandGen(Concept concept) {
    ...
    setChild("cars", Cars(carConcept) as IEntities<Brand>);
  }
  ...
  void set length(int a) {
    setAttribute("length", a);
  }

  String get colorName => getAttribute("colorName");

  void set colorName(String a) {
    setAttribute("colorName", a);
  }

  String get color => getAttribute("color");

  void set color(String a) {
    setAttribute("color", a);
  }
  ...
  void set green(int a) {
    setAttribute("green", a);
  }
