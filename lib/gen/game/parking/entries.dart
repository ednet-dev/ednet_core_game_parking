...
// lib/gen/game/parking/model_entries.dart
...
class ParkingEntries extends ModelEntries {
  ...
  Areas get areas => getEntry("Area") as Areas;

  Brands get brands => getEntry("Brand") as Brands;

  Parkings get parkings => getEntry("Parking") as Parkings;
}
